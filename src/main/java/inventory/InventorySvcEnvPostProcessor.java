...
public class InventorySvcEnvPostProcessor implements EnvironmentPostProcessor {
  ...
  static final String SECRETS_ENABLED_PROPERTY = "spring.cloud.kubernetes.secrets.enabled";
  static final String SECRETS_PATHS_PROPERTY = "spring.cloud.kubernetes.secrets.paths";
  ...
  public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
    ...
    for( String spath : spaths ) {
      ...
      if( d.exists() ) {
        ...
        File[] items = d.listFiles(new FileFilter() {
          @Override
